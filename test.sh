...
try 42 "main () { int a; a = 42; return a; }"
try 42 "main () { int var; var = 4; return var * 10 + 2;}"
...
try 55 "main () { int x; int sum; x = 10; sum = 0; while (x != 0) { sum = sum + x; x = x - 1; } return sum; }"
try 0 "main () { int x; int y; x = y = 0; return x; }"
try 55 "main () { int i; int sum; sum = 0; for (i = 1; i <= 10; i = i + 1) { sum = sum + i; } return sum; }"
